...
public class VendingMachineGUI extends JFrame {
    ...
    private void addCreateVendingMachineScene() {
        ...
        JButton createSpecialMachineButton = new JButton("Create a MilkTea Machine Machine");
    ...
    private void addTestVendingMachineScene() {
            ...
            JButton testSpecialMachineButton = new JButton("Test a Milk Tea Machine");
    ...
    public void regBuy(Controller controller){
        ...
        if (controller.getItemQty(name) <= 0){
            ...
            controller.setRegMoneyBox(controller.getRegMoneyBox() + price);
            testRegularVendingMachine(controller);
        }
    }
    ...
    public void createSpecialVendingMachine(){
        ...
        String name = JOptionPane.showInputDialog(this, "Enter the name of the MilkTea machine:", "Create a Special Vending Machine", JOptionPane.QUESTION_MESSAGE);
    ...
    public void specBuy(Controller controller){
        ...
        JOptionPane.showMessageDialog(null,"Preparing Cup");
        JOptionPane.showMessageDialog(null,"Mixing MilkTea with desired sugar level");
        JOptionPane.showMessageDialog(null,"Pouring Sinkers");
        JOptionPane.showMessageDialog(null,"Pouring Ice");
        JOptionPane.showMessageDialog(null,"Pouring MilkTea");
        JOptionPane.showMessageDialog(null,"Sealing Cup");
        JOptionPane.showMessageDialog(null,"Dispensing MilkTea w/ Straw");
        ...
        controller.setSpecMoneyBox(controller.getSpecMoneyBox() + bill);
        testSpecialVendingMachine(controller);
